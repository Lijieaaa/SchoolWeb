...
//echo $job_duties;
$sql="insert into job(company_name,job_name,job_family,job_time,interndeadline,update_time,money_buttom,money_Top,education,company_situation,family,city,cityAddress,fuli,youhuo,job_duties,job_entails,expiration_time,checkid)
 ...
 '$workCity','$cityAddress','$fuli','$youhuo','$job_duties','$job_entails','$expiration_time','1')";
