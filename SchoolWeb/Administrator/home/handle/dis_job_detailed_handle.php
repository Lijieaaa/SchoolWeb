...
//echo $job_duties;
 ...
 $sql="update job set job_name='$jobtitle',job_family='$job_family',job_time='$internWorkDay',interndeadline='$interndeadline',update_time='$update_time',money_buttom='$monthBottomSalary',
 money_Top='$monthTopSalary',education='$xue',company_situation='company_situation',family='$jobcategory',city='$workCity',cityAddress='$cityAddress',fuli='$fuli',youhuo='$youhuo',
 job_duties='$job_duties',job_entails='$job_entails',expiration_time='$expiration_time' where company_name='$companyname'";
